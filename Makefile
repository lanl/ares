...
CMAKE_FLAGS      = -DCMAKE_BUILD_TYPE="Release" -DLLVM_TARGETS_TO_BUILD="X86" -G Ninja -DCMAKE_INSTALL_PREFIX=../$(LLVM_INSTALL_DIR) -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++
